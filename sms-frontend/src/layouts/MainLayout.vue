...
const teacherNav = [
  ...
  },
  {
    ...
    path: "/teacher/attendance-recap",
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4",
  },
  {
    name: "Manajemen Rapor",
    path: "/teacher/report-management",
    icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
  },
  {
    name: "Penilaian Eskul",
    path: "/teacher/eskul-grading",
    icon: "M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    requiresEskulPIC: true,
  },
];
...
const studentNav = [
  ...
  },
  {
    ...
    path: "/student/eskul",
    icon: "M12 8v13m0-13V6a4 4 0 00-4 4v4h8v-4a4 4 0 00-4-4zm-7 8h14M5 8h14a2 2 0 012 2v7a2 2 0 01-2 2H5a2 2 0 01-2-2v-7a2 2 0 012-2z",
  },
];
...
const principalNav = [
  ...
  {
    name: "Bobot Nilai",
    path: "/principal/settings/grading",
    icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z",
  },
  {
    name: "Tren Akademik",
    path: "/principal/academic-trends",
...
const currentNavigation = computed(() => {
  switch (authStore.userRole) {
    case "admin":
      return adminNav;
    case "teacher":
      // Filter out eskul grading menu if teacher is not a PIC
      if (!authStore.user?.is_pic_eskul) {
        return teacherNav.filter(item => !item.requiresEskulPIC);
      }
      return teacherNav;
    case "student":
      return studentNav;
